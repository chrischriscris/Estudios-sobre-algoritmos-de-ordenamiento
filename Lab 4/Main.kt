...
fun generateData(tries: Int, sequence: String, seqSizes: Sequence, algSet: String):
    ...
    val algNames = arrayOf(
        ...
        "Merge-Insertion Sort", "Merge-Iterative Sort", "Heap Sort", "Quicksort",
        "Randomized Quicksort", "3-way Partition Quicksort", "Introsort",
        )

    val sortFunctions = arrayOf(
        ::bubbleSort, ::insertionSort, ::selectionSort, ::shellSort,
        ::mergeSortInsertion, ::iterativeMergeSort, ::heapSort, ::quicksort,
        ::randomizedQuicksort, ::threeWayQuicksort, ::introsort,
        )
